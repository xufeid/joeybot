...
<a href="https://gmgn.ai/sol/token/${GMGN_REFERAL_CODE}_${tokenInfo.address}">GMGN</a>${tokenInfo.website ? ` | <a href="https://t.me/GMGN_sol_bot?start=i_${GMGN_REFERAL_CODE}_c_${tokenInfo.address}">GMGN TG Bot</a>
<a href="https://dexscreener.com/solana/${tokenInfo.address}">DexScreener</a> |  <a href="${tokenInfo.website}">Website</a>` : ''}${tokenInfo.twitter ? ` | <a href="${tokenInfo.twitter}">Twitter</a>` : ''}
`.trim();
}
